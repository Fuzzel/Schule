...
public class CalMenufinal {
    ...
    if (number1 == parent && number2 == child) {
      System.out.println("Richtig der Vorgänger von " + Random + " ist " + parent + " und der Nachfolger ist " + child);
      ...
      switch (weiterleitung) {
        ...
        case 3:
          ...
          menueselection(feed);
        break;
        default: System.out.println("Bis zum nächsten mal ^.^");
        }
    } // end of if
    else {
      System.out.println("Das sind Leider die Falschen Ergebnisse :( Richtig wäre der Vorgänger " + parent + " und der Nachfolger " + child);
    ...
    if (number1 == parent && number2 == child) {
      System.out.println("Richtig der Vorgänger Zehner von " + Random + " ist " + parent + " und der Nachfolge Zehner ist " + child);
      System.out.println("Möchtest du 1. weiter üben 2. die nächste Aufgabe. 3. Zurück ins Menü. 4. Programm beenden.");
      int weiterleitung = sc.nextInt();
      switch (weiterleitung) {
        case 1:
      ...
      System.out.println("Das sind Leider die Falschen Ergebnisse :( Richtig wäre der Vorgänger Zehner " + parent + " und der Nachfolge Zehner " + child);
      System.out.println("Zur Übung bekommst du einen neuen Versuch.");
      parentchild10er();
    } // end of if-else    
    }
    ...
    if (number1 == parent && number2 == child) {
      System.out.println("Richtig der Vorgänger Hunderter von " + Random + " ist " + parent + " und der Nachfolge Hunderter ist " + child);
      System.out.println("Möchtest du 1. weiter üben 2. die nächste Aufgabe. 3. Zurück ins Menü. 4. Programm beenden.");
      int weiterleitung = sc.nextInt();
      switch (weiterleitung) {
        case 1:
      ...
      System.out.println("Das sind Leider die Falschen Ergebnisse :( Richtig wäre der Vorgänger Hunderter " + parent + " und der Nachfolge Hunderter " + child);
      System.out.println("Zur Übung bekommst du einen neuen Versuch.");
      parentchild100er();
    } // end of if-else
    }
    ...
    public static int feed() {
        System.out.println("1. Addieren, 2. Multiplizieren, 3. Runden, 4. Vorgaenger/Nachfolger, 5. Zahlen vergleichen, 6. Subtrahieren, 7 Dividieren, 8. Programmende");
    ...
    public static void menueselection(int feed) {
        ...
        do{
            ...
            case 6:
                ...
                parentchild1MIOer();
                break;
                default: System.out.println("Ungültige Eigabe!");
